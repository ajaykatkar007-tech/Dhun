...
@Entity(tableName="cached_songs") data class SongEntity(@PrimaryKey val id:Long,val title:String,val artist:String,val album:String,val durationMs:Long,val contentUri:String,val albumArtUri:String?,val folder:String,val dateAdded:Long)
